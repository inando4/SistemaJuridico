...
- Revisión de las ocho enmiendas completada el 2026-09-06: 16/16 controles de calidad,
  28 requisitos, 12 criterios de éxito y 7 historias. No acredita implementación.
...
- Sesión: FR-002, historia 1.5–6 y SC-011 establecen 30 días desde el ingreso, sin caducidad
  por inactividad durante ese período, con revocación por cierre o cambio de credenciales.
  Es un supuesto explícito de producto, no un estándar atribuido a redes sociales.
...
- Seguimiento documental: constitución 2.0.0 aún contiene auditoría sin modificaciones
  en II, VII y controles. La enmienda expresa prevalece en esta spec; sincronizar mediante
  `$speckit-constitution`. La calidad de esta spec no acredita sincronización constitucional.
- Supuestos revisables: sesión de 30 días, administración por JEFA, correos de acceso,
...
- Sin hooks antes ni después de la especificación. Se conserva el directorio 001 y
  `.specify/feature.json`. Lista preparada para `$speckit-plan`, con el seguimiento
  constitucional anterior visible para su control de conformidad.

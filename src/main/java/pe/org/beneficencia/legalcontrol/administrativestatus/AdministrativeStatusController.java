...
/** Catalogo de estados administrativos: lo consulta cualquiera, lo administra JEFA. */
@Controller
public class AdministrativeStatusController {

    private final AdministrativeStatusRepository catalogo;
    private final AdministrativeStatusService servicio;

    public AdministrativeStatusController(AdministrativeStatusRepository catalogo,
                                          AdministrativeStatusService servicio) {
    ...
    @GetMapping("/estados-administrativos")
    public String listado(Model modelo) {
        modelo.addAttribute("estados", catalogo.todos());
        modelo.addAttribute("tituloPagina", "Estados de procedimientos administrativos");
        return "administrative-statuses/list";
    }

    @PostMapping("/estados-administrativos")
    public String crear(@RequestParam String name,
        ...
        return "redirect:/estados-administrativos";
    }

    @PostMapping("/estados-administrativos/{id}/disponibilidad")
    ...
    @PostMapping("/estados-administrativos/{id}/eliminar")
